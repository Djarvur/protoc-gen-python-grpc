...
func TestRunPluginWithIO_ReadError(t *testing.T) {
	...
	// Assert
	require.Error(t, err)
	require.ErrorIs(t, err, kit.ErrReadRequest)
}
...
func TestRunPluginWithIO_NoFileToGenerateError(t *testing.T) {
	...
	// Assert
	require.Error(t, err)
	require.ErrorIs(t, err, kit.ErrNoFileToGenerate)
}
...
func TestRunPluginWithIO_WriteError(t *testing.T) {
	...
	// Assert
	require.Error(t, err)
	require.ErrorIs(t, err, kit.ErrWriteResponse)
}
...
func TestRunPluginWithIO_GenerateError(t *testing.T) {
	...
	// Assert
	require.Error(t, err)
	require.ErrorIs(t, err, kit.ErrGenerate)
}
